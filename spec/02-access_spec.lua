...
describe("Plugin: prometheus (access) exposing tags", function()
  ...
  setup(function()
    ...
    local service = bp.services:insert {
      ...
      port = helpers.mock_upstream_port,
      protocol = helpers.mock_upstream_protocol,
      tags = {"service-http-tag1", "service-http-tag2"},
    }
    ...
    bp.routes:insert {
      ...
      methods = { "GET" },
      service = service,
      tags = {"route-http-tag1", "route-http-tag2"},
    }

    local grpc_service = bp.services:insert {
      name = "mock-grpc-service",
      url = "grpc://grpcbin:9000",
      tags = {"service-grpc-tag1", "service-grpc-tag2"},
    }
    ...
    bp.routes:insert {
      ...
      hosts = { "grpc" },
      service = grpc_service,
      tags = {"route-grpc-tag1", "route-grpc-tag2"},
    }

    local grpcs_service = bp.services:insert {
      name = "mock-grpcs-service",
      url = "grpcs://grpcbin:9001",
      tags = {"service-grpcs-tag1", "service-grpcs-tag2"},
    }
    ...
    bp.routes:insert {
      ...
      hosts = { "grpcs" },
      service = grpcs_service,
      tags = {"route-grpcs-tag1", "route-grpcs-tag2"},
    }

    local tcp_service = bp.services:insert {
      name = "tcp-service",
      url = "tcp://127.0.0.1:" .. TCP_SERVICE_PORT,
      tags = {"service-tcp-tag1", "service-tcp-tag2"},
    }
    ...
    bp.routes:insert {
      ...
      service = tcp_service,
      destinations = { { port = TCP_PROXY_PORT } },
      tags = {"route-tcp-tag1", "route-tcp-tag2"},
    }
  ...
  it("increments the count for proxied requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-service",route="http-route",code="200",service_tags="service-http-tag1,service-http-tag2",route_tags="route-http-tag1,route-http-tag2"} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-service",route="http-route",code="400",service_tags="service-http-tag1,service-http-tag2",route_tags="route-http-tag1,route-http-tag2"} 1', nil, true)
    end)
  end)
  ...
  it("increments the count for proxied grpc requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-grpc-service",route="grpc-route",code="200",service_tags="service-grpc-tag1,service-grpc-tag2",route_tags="route-grpc-tag1,route-grpc-tag2"} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-grpcs-service",route="grpcs-route",code="200",service_tags="service-grpcs-tag1,service-grpcs-tag2",route_tags="route-grpcs-tag1,route-grpcs-tag2"} 1', nil, true)
    end)
  end)
  ...
  pending("increments the count for proxied TCP streams", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_stream_status{service="tcp-service",route="tcp-route",code="200",service_tags="service-tcp-tag1,service-tcp-tag2",route_tags="route-tcp-tag1,route-tcp-tag2"} 1', nil, true)
    end)
  end)
end)
...
describe("Plugin: prometheus (access) exposing only route tags", function()
  ...
  it("increments the count for proxied requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-service",route="http-route",code="200",service_tags="",route_tags="route-http-tag1,route-http-tag2"} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-service",route="http-route",code="400",service_tags="",route_tags="route-http-tag1,route-http-tag2"} 1', nil, true)
    end)
  end)
  ...
  it("increments the count for proxied grpc requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-grpc-service",route="grpc-route",code="200",service_tags="",route_tags="route-grpc-tag1,route-grpc-tag2"} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-grpcs-service",route="grpcs-route",code="200",service_tags="",route_tags="route-grpcs-tag1,route-grpcs-tag2"} 1', nil, true)
    end)
  end)
  ...
  pending("increments the count for proxied TCP streams", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_stream_status{service="tcp-service",route="tcp-route",code="200",service_tags="",route_tags="route-tcp-tag1,route-tcp-tag2"} 1', nil, true)
    end)
  end)
end)
...
describe("Plugin: prometheus (access) exposing only service tags", function()
  ...
  it("increments the count for proxied requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-service",route="http-route",code="200",service_tags="service-http-tag1,service-http-tag2",route_tags=""} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-service",route="http-route",code="400",service_tags="service-http-tag1,service-http-tag2",route_tags=""} 1', nil, true)
    end)
  end)
  ...
  it("increments the count for proxied grpc requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-grpc-service",route="grpc-route",code="200",service_tags="service-grpc-tag1,service-grpc-tag2",route_tags=""} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_status{service="mock-grpcs-service",route="grpcs-route",code="200",service_tags="service-grpcs-tag1,service-grpcs-tag2",route_tags=""} 1', nil, true)
    end)
  end)
  ...
  pending("increments the count for proxied TCP streams", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_stream_status{service="tcp-service",route="tcp-route",code="200",service_tags="service-tcp-tag1,service-tcp-tag2",route_tags=""} 1', nil, true)
    end)
  end)
end)
...
describe("Plugin: prometheus (access) per-consumer metrics and exposing tags", function()
  local proxy_client
  local admin_client
  ...
  it("increments the count for proxied requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_consumer_status{service="mock-service",route="http-route",code="200",consumer="alice",service_tags="service-tag1,service-tag2",route_tags="route-tag1,route-tag2"} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_http_consumer_status{service="mock-service",route="http-route",code="400",consumer="alice",service_tags="service-tag1,service-tag2",route_tags="route-tag1,route-tag2"} 1', nil, true)
    end)
  end)
  ...
  it("behave correctly if consumer is not found", function()
    ...
    helpers.wait_until(function()
      ...
      body = assert.res_status(200, res)
      return body:find('kong_http_status{service="mock-service",route="http-route",code="200",service_tags="service-tag1,service-tag2",route_tags="route-tag1,route-tag2"} 1', nil, true)
    end)

    assert.not_match('kong_http_consumer_status{service="mock-service",route="http-route",code="401",consumer="alice",service_tags="service-tag1,service-tag2",route_tags="route-tag1,route-tag2"} 1', body, nil, true)
    assert.matches('kong_http_status{service="mock-service",route="http-route",code="401",service_tags="service-tag1,service-tag2",route_tags="route-tag1,route-tag2"} 1', body, nil, true)
